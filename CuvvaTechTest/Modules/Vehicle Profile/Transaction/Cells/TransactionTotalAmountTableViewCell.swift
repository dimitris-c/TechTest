...
class TransactionTotalAmountTableViewCell: UITableViewCell {
    static let identifier = "transaction.total.amount.tableview.id"
    
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .value1, reuseIdentifier: reuseIdentifier)
        
        self.textLabel?.font = DesignStyling.Fonts.headerTitle
        self.textLabel?.textColor = DesignStyling.Colours.titleDarkBlue
        
        self.detailTextLabel?.font = DesignStyling.Fonts.headerTitle
